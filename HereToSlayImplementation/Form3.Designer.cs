namespace HereToSlayImplementation
{
    partial class Form3
    {
        ...
        private void InitializeComponent()
        {
            ...
            DieButton1 = new Button();
            DieButton2 = new Button();
            ActionPointsTextBox = new TextBox();
            ActionPointRecorderTextBox1 = new TextBox();
            textBox1 = new TextBox();
            textBox2 = new TextBox();
            textBox3 = new TextBox();
            GameAnnouncementsLabelTextBox = new TextBox();
            DeckButton = new Button();
            CardButton1 = new Button();
            MonsterButton3 = new Button();
            MonsterButton2 = new Button();
            ...
            // 
            // PartySelectorListBox
            // 
            PartySelectorListBox.BackColor = Color.DarkGray;
            ...
            Controls.Add(PartyLabelTextBox);
            ...
            Controls.Add(MonsterButton1);
            Controls.Add(MonsterButton2);
            Controls.Add(MonsterButton3);
            Controls.Add(DeckButton);
            Controls.Add(GameAnnouncementsLabelTextBox);
            Controls.Add(textBox3);
            Controls.Add(textBox2);
            Controls.Add(textBox1);
            Controls.Add(ActionPointRecorderTextBox1);
            Controls.Add(ActionPointsTextBox);
            Controls.Add(DieButton2);
            Controls.Add(DieButton1);
            Controls.Add(PartyLeaderButton);
        ...
        private Button PartyLeaderButton;
        private Button SlainMonster1Button;
        private Button SlainMonster2Button;
        private Button SlainMonster3Button;
        private Button DieButton1;
        private Button DieButton2;
        private TextBox ActionPointsTextBox;
        private TextBox ActionPointRecorderTextBox1;
        private TextBox textBox1;
        private TextBox textBox2;
        private TextBox textBox3;
        private TextBox GameAnnouncementsLabelTextBox;
        private Button DeckButton;
        private Button CardButton1;
        private Button MonsterButton3;
        ...
        private Button ItemEffectButton5;
        private Button CardButton3;
        private Button button8;
        private Button CardButton4;
        private Button button10;
        private Button CardButton2;
        private Button ItemEffectButton2;
        private TextBox PartyLabelTextBox;
